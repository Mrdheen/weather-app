...
export default function WCASummit() {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between bg-white mx-auto">
      {/* Left Side: Image */}
      <div className="w-full w-1/3">
        <Image
          src="/Image Placeholder (5).png" // Replace with your actual image path
      ...
      {/* Right Side: Content */}
      <div className="w-full md:w-2/3 p-5 md:pl-10 mt-8 md:mt-0">
